...
async def send_purchase_currency_notification():
    ...
    while config_chat['purchase_message']:
        ...
        for target_time in target_times:
            ...
            time_lower_bound = target_time_with_deviation - datetime.timedelta(hours=12, minutes=2)
            time_upper_bound = target_time_with_deviation + datetime.timedelta(hours=12, minutes=2)
